...
const MoreMobile = ({user_id}) => {
	...
	return (
		<>
		<img src={moreDots} alt="" onClick={toggleMore} className="cursor-pointer p-2 self-end hover:bg-black hover:bg-opacity-20 rounded-full"/>
		{isOpen &&
					...
					<div className="w-[90%]">
						<div className="app-card w-full">
							<div className="border-b-[1px] p-4 border-grey26 justify-items-center">
								<p className='text-red text-center'>Not interested on this post</p>
							</div>
							<div className="border-b-[1px] p-4 border-grey26  justify-items-center">
						...
						<br />
						<div onClick={toggleMore} className="app-card justify-items-center w-full">
							<div className="border-b-[1px] p-4 border-grey26 justify-items-center">
