         ...
         <div className='flex justify-center w-full sm:w-1/2 m-auto'>
            <div className="flex justify-center mt-4"> 
                <Link to={'/crypto-exchange'}>
                    <button className=" mr-4 text-black flex justify-center items-center py-3 w-[132px] bg-primary rounded-[40px] text-[14px] font-bold">Copy</button>
                </Link>
                <div className="cursor-pointer text-white border-[1px] border-white flex justify-center items-center py-3 w-[132px] rounded-[40px] text-[14px] font-bold">Follow</div>
            </div> 
        </div>
...
export default PTcopyTradingInvestor;
