...
const CreatePoolForm = () => {
    ...
    const {isLoading, error, createFamilyPool} = useCreateFamilyPool()
        ...
        <div className="flex flex-col relative">
            <div className="bg-darkGrey  rounded-lg min-h-[500px] relative">
                    ...
                    <StepNavigation
                     ...
                     isFinal={endForm}
                     title={activeTab === 0 ? 'Family Pool Meta' 
                     : activeTab === 1 ? 'Deposit & Members' 
                     : activeTab === 2 ? 'Deposit Network' 
                     : 'Create Family Pool'}
                     currentStep={activeTab}
                     />
                    {activeTab === 0 && <FamilyPoolMeta handleName={handleName} handleExchange={handleExchange}/>}
                    {activeTab === 1 && <FamilyPoolDeposit action={handleRangeInput} depositValue={depositValue} memberValue={memberValue}   />}
