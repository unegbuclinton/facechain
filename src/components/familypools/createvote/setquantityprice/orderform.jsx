    ...
    return (
        <div className="mb-14">
            <div className="mb-6">
                ...
                <div className="flex bg-[#2E2C2C] justify-between px-4 py-2 rounded-sm">
                    <div className="flex items-center">
                        <img className="w-[40px] h-[40px] mr-2 rounded-full object-cover" src={item.image} alt="" />
            ...
            <div className="mb-6">
                 ...
                 <div className="flex">
                    <input placeholder="Enter a quantity" className="w-[85%] px-4 py-2 text-white outline-0 bg-[#292929]" />
                    <div className="w-[15%] px-4 py-2 text-white text-[14px] outline-0 bg-[#292929]">
                        <p className="text-[#5E5E5E] text-right">BTC</p>
                    </div>
                 </div>
                 <p className="text-[#979797] text-[12px] mt-2">Available   0.05122222 USDT</p>
            </div>
            {type === 'Limit Order' && (
                 <div>
