...
const ForgotPasswordForm = () => {
    ...
    return (
        <div className="text-white text-center sm:px-40 flex flex-col justify-evenly flex-1">
            ...
            <h2 className="text-white font-buttons text-3xl font-extrabold">Forgot Password</h2>
            <form className="-mt-20 sm:-mt-10" action="">
                <div className="relative">
                     ...
                     <label className="float-label transition-all">Email/Phone number</label>
                </div>
               
                <Link to="/submit-code"><button className="bg-primary font-buttons text-black text-lg font-bold w-full rounded-full py-3 mt-5">Continue</button></Link>
            </form>
